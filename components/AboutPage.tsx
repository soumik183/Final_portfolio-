...
const AboutPage: React.FC = () => {
    return (
        <div className="space-y-16 md:space-y-24 animate-fade-in py-12 md:py-20">
            <section id="about-me" className="text-center">
                <img src="https://picsum.photos/id/1005/150/150" alt="Soumik Bairagi" className="w-40 h-40 rounded-full mx-auto mb-6 shadow-lg border-4 border-white dark:border-slate-700" />
                <h1 className="text-4xl md:text-5xl font-bold mb-4 brutalist-font creative-font">Hi, I'm Soumik Bairagi</h1>
